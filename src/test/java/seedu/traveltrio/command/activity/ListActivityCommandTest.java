...
class ListActivityCommandTest {
    ...
    void execute_emptyActivityList_throwsException() {
        ...
        ListActivityCommand command = new ListActivityCommand(activityList);
    ...
    void execute_nonEmptyActivityList_returnsItineraryList() throws TravelTrioException {
        ...
        ActivityList activityList = new ActivityList(trip);
        Activity activity1 = new Activity("Diving", "Okinawa", "2026-06-10", "09:00", "15:00");
        Activity activity2 = new Activity("Hiking", "Fuji Mountain", "2026-06-13", "13:00", "14:30");
        ...
        String expected = "Itinerary for Japan Trip:\n"
                + header + "\n"
